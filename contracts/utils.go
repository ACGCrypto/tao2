...
import (
	...
	"github.com/taoblockchain/tao2/contracts/blocksigner/contract"
	randomizeContract "github.com/taoblockchain/tao2/contracts/randomize/contract"
	"github.com/taoblockchain/tao2/core"
	"github.com/taoblockchain/tao2/core/state"
	stateDatabase "github.com/taoblockchain/tao2/core/state"
...
func GetRandomizeFromContract(client bind.ContractBackend, addrMasternode common.Address) (int64, error) {
	randomize, err := randomizeContract.NewTaoRandomize(common.HexToAddress(common.RandomizeSMC), client)
	if err != nil {
