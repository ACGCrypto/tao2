...
import (
	...
	"github.com/taoblockchain/tao2/common/fdlimit"
...
var (
	...
	NetworkIdFlag = cli.Uint64Flag{
		Name:  "networkid",
		Usage: "Network identifier (integer, 89=Tao)",
...
func SetP2PConfig(ctx *cli.Context, cfg *p2p.Config) {
	...
	log.Info("Maximum peer count", "TAO", ethPeers, "LES", lightPeers, "total", cfg.MaxPeers)
