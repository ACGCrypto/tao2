...
func makeConfigNode(ctx *cli.Context) (*node.Node, tomoConfig) {
	...
	utils.SetWaihuiConfig(ctx, &cfg.Waihui)
...
func makeFullNode(ctx *cli.Context) (*node.Node, tomoConfig) {
	...
	// Register Waihui's OrderBook service if requested.
	// enable in default
	utils.RegisterWaihuiService(stack, &cfg.Waihui)
