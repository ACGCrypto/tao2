...
func TestConsoleWelcome(t *testing.T) {
	...
	tao := runTao(t,
		"--waihui.datadir", tmpdir(t)+"waihui/"+time.Now().String(),
	...
	tao.SetTemplateFunc("niltime", func() string { return time.Unix(1585757340, 0).Format(time.RFC1123) })
...
func testAttachWelcome(t *testing.T, tao *testtomo, endpoint, apis string) {
	...
	attach.SetTemplateFunc("niltime", func() string { return time.Unix(1585757340, 0).Format(time.RFC1123) })
