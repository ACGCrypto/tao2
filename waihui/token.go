...
func (waihui *Waihui) GetTokenDecimal(chain consensus.ChainContext, statedb *state.StateDB, coinbase common.Address, tokenAddr common.Address) (*big.Int, error) {
	...
	waihui.tokenDecimalCache.Add(tokenAddr, tokenDecimal)
