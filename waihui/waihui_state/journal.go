...
func (ch insertOrder) undo(s *WaihuiStateDB) {
	s.CancelOrder(ch.orderBook, ch.order)
}
func (ch cancelOrder) undo(s *WaihuiStateDB) {
	s.InsertOrderItem(ch.orderBook, ch.orderId, ch.order)
}
func (ch subAmountOrder) undo(s *WaihuiStateDB) {
...
func (ch nonceChange) undo(s *WaihuiStateDB) {
	s.SetNonce(ch.hash, ch.prev)
}
func (ch priceChange) undo(s *WaihuiStateDB) {
