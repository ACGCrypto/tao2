...
func AddTokenBalance(addr common.Address, value *big.Int, token common.Address, statedb *state.StateDB) error {
	...
	if token.String() == common.TaoNativeAddress {
		...
		log.Debug("ApplyWaihuiMatchedTransaction settle balance: ADD TOKEN TAO NATIVE BEFORE", "token", token.String(), "address", addr.String(), "balance", balance, "orderValue", value)
		balance = balance.Add(balance, value)
		statedb.SetBalance(addr, balance)
		log.Debug("ApplyWaihuiMatchedTransaction settle balance: ADD TAO NATIVE BALANCE AFTER", "token", token.String(), "address", addr.String(), "balance", balance, "orderValue", value)
...
func SubTokenBalance(addr common.Address, value *big.Int, token common.Address, statedb *state.StateDB) error {
	...
	if token.String() == common.TaoNativeAddress {
		...
		balance := statedb.GetBalance(addr)
		log.Debug("ApplyWaihuiMatchedTransaction settle balance: SUB TAO NATIVE BALANCE BEFORE", "token", token.String(), "address", addr.String(), "balance", balance, "orderValue", value)
		...
		statedb.SetBalance(addr, balance)
		log.Debug("ApplyWaihuiMatchedTransaction settle balance: SUB TAO NATIVE BALANCE AFTER", "token", token.String(), "address", addr.String(), "balance", balance, "orderValue", value)
		return nil
	}
