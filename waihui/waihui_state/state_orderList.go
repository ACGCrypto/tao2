...
func newStateOrderList(db *WaihuiStateDB, orderType string, orderBook common.Hash, price common.Hash, data orderList, onDirty func(price common.Hash)) *stateOrderList {
...
func (self *stateOrderList) deepCopy(db *WaihuiStateDB, onDirty func(price common.Hash)) *stateOrderList {
