...
func newStateExchanges(db *WaihuiStateDB, hash common.Hash, data exchangeObject, onDirty func(addr common.Hash)) *stateExchanges {
...
func (self *stateExchanges) deepCopy(db *WaihuiStateDB, onDirty func(hash common.Hash)) *stateExchanges {
